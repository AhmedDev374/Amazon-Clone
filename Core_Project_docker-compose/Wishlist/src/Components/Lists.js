...
import "./lists.css";
import React, { useState, useEffect } from "react";  // ✅ includes useState & useEffect
import { getAuth, onAuthStateChanged } from "firebase/auth";  // ✅ import Firebase auth
import { app } from "../Firebase";  // ✅ import your initialized Firebase app

function Lists() {
  const [AddedIds, setAddedIds] = useState([]);
  const [user, setUser] = useState(null);   // ✅ declare setUser
                ...
                return (
                  <div className="card" key={items.id}>
                    <div className="card-img-data">
                      <img src={items.image} className="card-img" alt={items.title} />
                      <img
                        onClick={() => {
                          if (!isAdded(items.id)) {
                    ...
                    <div className="card-data">
                      ...
                      <div className="category-rating">
                        ...
                        <div className="rating">
                          <img src={rating} className="rating-img" alt="star rating" />
                          <img src={rating} className="rating-img" alt="star rating" />
                          <img src={rating} className="rating-img" alt="star rating" />
                          <img src={rating} className="rating-img" alt="star rating" />
                          <img src={rating} className="rating-img" alt="star rating" />
